...
const Articles = () => {
  ...
  return (
    <section className="flex flex-col gap-3 laptop-lg:gap-5 justify-center h-fit w-full laptop-lg:pt-10 pt-5">
      <H1 heading="Articles" />
      <div
        id="archive-articles"
        className="grid grid-cols-1 tablet-lg:grid-cols-2 border-t border-l border-text"
      >
        {FILTERED_ARTICLES.current.map((article, index) => {
          return (
            <div
              key={index}
